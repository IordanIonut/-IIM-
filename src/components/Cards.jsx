...
const Cards = ({ projects }) => {
  return (
    <div class="flex flex-col gap-2.5 items-start justify-start shrink-0 relative">
      <div
        class="bg-[#1e1e1e] rounded-[40px] pt-5 pr-[30px] pb-5 pl-[30px] flex flex-col gap-10 items-center justify-start shrink-0  w-[350px] h-[500px] relative overflow-hidden"
        ...
        <div class="flex flex-col gap-10 items-start justify-start self-stretch shrink-0 relative">
          ...
          <div class="flex flex-row gap-5 items-start justify-start flex-wrap self-stretch shrink-0 relative">
            {projects?.keyWords?.map((project, index) => (
              <div
                key={index}
                class="bg-[#006400] rounded-[60px] p-[5px] flex flex-row gap-0.5 items-start justify-start shrink-0 relative"
              >
